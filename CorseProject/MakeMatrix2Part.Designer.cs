namespace CorseProject
{
    partial class MakeMatrix2Part
    {
        ...
        "ва от главной диагонали.\r\nОставшиеся ячейки заполняются автоматически.");
            ...
            this.SaveChanges.Text = "Сохранить значения";
            this.toolTip3.SetToolTip(this.SaveChanges, "Сохранение значений введённой матрицы");
